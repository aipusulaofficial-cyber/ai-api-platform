...
## Core boundary
**Primary concern:** API platform.

Use contract-first interfaces with validation and version boundaries; normalize errors; preserve request correlation; isolate transport from domain policy; test malformed, unauthorized, and dependency-failure paths.
